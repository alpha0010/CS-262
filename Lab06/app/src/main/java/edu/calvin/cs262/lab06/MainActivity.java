...
public class MainActivity extends AppCompatActivity {
    ...
    private void updateDisplay() {
        ...
        for (Weather item : weatherList) {
            ...
            map.put("min_temp", item.getMin());
            map.put("max_temp", item.getMax());
            data.add(map);
        }

        int resource = R.layout.weather_item;
        String[] from = {"day", "description", "min_temp", "max_temp"};
        int[] to = {R.id.dayTextView, R.id.summaryTextView, R.id.minTempTextView, R.id.maxTempTextView};
